...
//
//        // Verify that the textures are loaded
...
//        assert backstoryCutscene.scenes.size() == 12;
//
...
//
//        // Verify the text for the first scene
...
//        assert entity.getCreatedComponents().size == 0;
//
...
public class BackstoryCutsceneTest {
    ...
    @Test
    public void testUpdateTriggersCutsceneEnd() {
        // Setup scenes and load the first one
        backstoryCutscene.setupScenes();
        backstoryCutscene.loadScene(0);

        // Mock game time to simulate time passing
