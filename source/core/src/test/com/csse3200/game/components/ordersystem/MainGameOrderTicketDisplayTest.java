...
class MainGameOrderTicketDisplayTest {
    ...
    void setUp() {
        ...
        lenient().when(ServiceLocator.getRenderService().getStage()).thenReturn(stage);
        lenient().when(ServiceLocator.getRenderService().getStage().getViewport()).thenReturn(viewport);
        lenient().when(ServiceLocator.getRenderService().getStage().getViewport().getCamera()).thenReturn(camera);
        lenient().when(ServiceLocator.getDocketService().getEvents()).thenReturn(eventHandler);
