...
public class MainGameActions extends Component {
    ...
    private String getRecipePreferenceForAnimal(String animalName) {
        // Assuming you have a method to get the recipe preference from the animal's data
        // You may need to retrieve this information from a component or service
        return "exampleRecipe"; // Replace with actual preference retrieval logic
    }
